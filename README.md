...
| <a name="output_shared_private_link_ids"></a> [shared\_private\_link\_ids](#output\_shared\_private\_link\_ids) | Map of "<service>/<link>" to the shared private link resource id. |
| <a name="output_shared_private_link_statuses"></a> [shared\_private\_link\_statuses](#output\_shared\_private\_link\_statuses) | Map of "<service>/<link>" to the connection status (Pending until the target owner approves it). |
