...
locals {
  ...
  srch_name = "srch-${var.short}-${var.loc}-${terraform.workspace}-001"
}
...
# Minimal call: one Azure AI Search service with the secure defaults, Entra-only auth, no public
# endpoint, and a system-assigned identity, on the basic SKU.
